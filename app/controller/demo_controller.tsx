...
export class DemoController {
    ...
    mountPoints(c: Context) {
        // Values set by mount point middleware in app/kernel.tsx
        // undefined when at /demo/mount-points, set when at /fr/ca/demo/mount-points
        ...
        const locale = localeKey
            ? (LOCALES[localeKey] ?? LOCALES['en-us'])
            : null
                ...
                <div class='container mx-auto px-4 py-12 max-w-4xl'>
                                ...
                                <div class='flex items-center gap-2'>
                                    ...
                                    <div>
                                        ...
                                        <p class='text-sm mt-1'>
                                            ...
                                            {' '}
                                            - Click a locale below to see the
                                            mount point in action
                                        </p>
                                    </div>
                                </div>
                            </Alert>
                    ...
                    <Card class='mb-8'>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Each button adds the locale prefix at START of
                                URL
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card class='mb-8'>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Real mount points configuration powering this
                                demo
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
