...
`/.specflow/specs/[###-feature-name]/spec.md`

**Note**: This template is filled in by the `__SPECFLOW_COMMAND_PLAN__` command.
See `.specflow/templates/plan-template.md` for the execution workflow.
