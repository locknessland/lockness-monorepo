...
export function registerCoreCommands(ace: Ace) {
    ace.register("make:controller", async (args) => {
        ...
        try {
            const content = await Stub.renderFrom(STUBS_PATH, 'make', 'controller', {
                className,
    ...
    ace.register("make:middleware", async (args) => {
        ...
        try {
            const content = await Stub.renderFrom(STUBS_PATH, 'make', 'middleware', {
                className
            });
    ...
    ace.register("make:service", async (args) => {
        ...
        try {
            const content = await Stub.renderFrom(STUBS_PATH, 'make', 'service', {
                className
            });
