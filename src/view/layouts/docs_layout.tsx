...
export const DocsLayout = (props: { title: string; children: any; currentPath: string }) => {
    return (
        <html lang='en' class='dark'>
            <head>
                ...
                <meta name='description' content='Complete documentation for Lockness JS - The fullstack MVC framework for Deno' />
                    ...
                    <div class='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                        <div class='flex items-center gap-6'>
                            ...
                            <div class='flex items-center gap-2 text-muted-foreground'>
                                ...
                                <BookIcon />
                                <span class='font-pixel text-[8px] mt-0.5'>DOCS</span>
                            </div>
                        </div>

                        <nav class='flex items-center gap-4'>
                            <a href='/' class='text-muted-foreground hover:text-primary transition-colors flex items-center gap-2' title='Back to home'>
                                <HomeIcon />
                            </a>
                            <a href='https://github.com/locknessjs/lockness' class='text-muted-foreground hover:text-primary transition-colors'>
