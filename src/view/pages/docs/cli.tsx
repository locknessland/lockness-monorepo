        ...
        <DocsLayout title='CLI (Ace) - Lockness JS' currentPath='/docs/cli'>
            <div class='max-w-4xl mx-auto'>
                ...
                <p class='text-xl text-gray-600 mb-8'>
                    Ace is Lockness's powerful command-line interface for
                    scaffolding, database management, and custom commands.
                </p>
                ...
                <section class='mb-12'>
                    ...
                    <div class='space-y-6'>
                        ...
                        <div>
                            ...
                            <p class='mb-2'>
                                Create a model with optional related files:
                            </p>
                            <CommandBlock lang='terminal'>
...
deno task ace queue:work --once             # Process once and exit`}
                ...
                <section class='mb-12'>
                    ...
                    <ul class='list-disc list-inside space-y-2 mb-6'>
                        <li>
                            All models from <InlineCode>src/model/</InlineCode>
                        </li>
                        <li>
                            All services from{' '}
                            <InlineCode>src/service/</InlineCode>
                        </li>
                        <li>
                            All repositories from{' '}
                            <InlineCode>src/repository/</InlineCode>
                        </li>
                    </ul>
...
👋 Bye!`}
                ...
                <section class='mb-12'>
                    ...
                    <p class='mb-4'>
                        This creates{' '}
                        <InlineCode>src/command/greet_command.ts</InlineCode>:
                    </p>
                    <CodeBlock lang='typescript'>
