        ...
        <DocsLayout title='Getting Started' currentPath='/docs/getting-started'>
            <div class='prose prose-invert max-w-none'>
                ...
                <p class='text-lg leading-relaxed mb-8'>
                    This guide will walk you through creating your first
                    Lockness application, from setup to deployment.
                </p>
                ...
                <p class='text-lg leading-relaxed mb-4'>
                    Let's create a simple API endpoint. Use the ACE CLI to
                ...
                <p class='text-lg leading-relaxed mb-4'>
                    This creates{' '}
                    <InlineCode>src/controller/hello_controller.ts</InlineCode>.
                    Edit it:
                </p>
...
export class HelloController {
    ...
    greet(c: Context) {
        ...
        return c.json({ message: \`Hello, \${name}!\` })
                ...
                <p class='text-lg leading-relaxed mb-8'>
                    Test it:{' '}
                    <InlineCode>http://localhost:5173/api/hello</InlineCode>
                </p>
                ...
                <p class='text-lg leading-relaxed mb-4'>
                    Create a model with repository, controller, and seeder in
                    one command:
                </p>
                ...
                <ul class='space-y-2 mb-8 text-lg'>
                    <li class='flex items-start gap-3'>
                        ...
                        <span>
                            <InlineCode>src/model/post.ts</InlineCode>{' '}
                    ...
                    <li class='flex items-start gap-3'>
                        <span class='text-primary mt-1'>▸</span>
                        <span>
                            <InlineCode>src/seeder/post_seeder.ts</InlineCode>
                            {' '}
                            - Test data
                        </span>
                    </li>
...
deno task ace db:seed`}
                ...
                <div class='space-y-2 mb-8'>
                    <div class='pixel-card p-3 bg-card/30'>
                        <code class='text-primary font-pixel-body text-sm'>
                            GET /api/posts
                        </code>
