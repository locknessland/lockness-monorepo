        ...
        <DocsLayout title='Components - Lockness JS'>
            <div class='max-w-4xl mx-auto'>
                ...
                <p class='text-xl text-gray-600 mb-8'>
                    Lockness uses JSX for building UI components. Generate
                    reusable components with the Ace CLI.
                </p>

                <section class='mb-12'>
                    <h2 class='text-3xl font-bold mb-4'>Creating Components</h2>
                    <p class='mb-4'>
                        Use the <InlineCode>make:component</InlineCode>{' '}
                        command to scaffold new JSX components:
                    </p>
                    ...
                    <p class='mb-4'>
                        This creates{' '}
                        <InlineCode>src/view/components/button.tsx</InlineCode>
                        {' '}
                        with:
                    </p>
        ...
        <div>
            ...
            {props.children}
                ...
                <section class='mb-12'>
                    ...
                    <p class='mb-4'>
                        Lockness follows these naming conventions for
                        components:
                    </p>
                    <div class='bg-blue-50 border-l-4 border-blue-500 p-4 mb-6'>
                        <ul class='list-disc list-inside space-y-2'>
                            <li>
                                <strong>Component class name:</strong>{' '}
                                PascalCase (e.g.,{' '}
                                <InlineCode>Button</InlineCode>,{' '}
                                <InlineCode>UserCard</InlineCode>)
                            </li>
                            <li>
                                <strong>File name:</strong> snake_case (e.g.,
                                {' '}
                                <InlineCode>button.tsx</InlineCode>,{' '}
                                <InlineCode>user_card.tsx</InlineCode>)
                            </li>
                            <li>
                                <strong>Props interface:</strong>{' '}
                                <InlineCode>
                                    {'<ComponentName>Props'}
                                </InlineCode>
                            </li>
                ...
                <section class='mb-12'>
                    ...
                    <p class='mb-4'>
                        Create components in subdirectories for better
                        organization:
                    </p>
                    <CommandBlock lang='terminal'>
        ...
        <div>
            <Card>
                ...
                <section class='mb-12'>
                    ...
                    <p class='mb-4'>
                        Lockness uses Hono's JSX runtime for server-side
                        rendering. Key features:
                    </p>
                        ...
                        <ul class='space-y-3'>
                            <li>
                                ...
                                <p class='text-gray-600 ml-6'>
                                    Use familiar JSX with TypeScript support
                                </p>
                            </li>
                            <li>
                                <strong class='text-lg'>✓ Props typing</strong>
                                <p class='text-gray-600 ml-6'>
                                    Full TypeScript intellisense for props
                                </p>
                            </li>
                            <li>
                                <strong class='text-lg'>
                                ...
                                <p class='text-gray-600 ml-6'>
                                    Components render on the server for fast
                                    initial load
                                </p>
                            </li>
                            <li>
                                ...
                                <p class='text-gray-600 ml-6'>
                                    Pass children to components like React
                                </p>
                            </li>
                        </ul>
                    </div>
...
└── docs_sidebar.tsx`}
                ...
                <section class='mb-12'>
                    ...
                    <div class='space-y-4'>
                        ...
                        <div class='bg-green-50 border-l-4 border-green-500 p-4'>
                            ...
                            <p class='text-gray-700'>
                                Define clear contracts for component APIs
                            </p>
                        </div>
                        <div class='bg-green-50 border-l-4 border-green-500 p-4'>
                            <p class='font-bold mb-2'>
                            ...
                            <p class='text-gray-700'>
                                Consistent with Lockness conventions
                            </p>
                        </div>
                        <div class='bg-green-50 border-l-4 border-green-500 p-4'>
                            <p class='font-bold mb-2'>
                ...
                <div class='bg-blue-50 border-l-4 border-blue-500 p-6'>
                    ...
                    <p class='mb-4'>
                        Now that you know how to create components, learn how to
                        use them in pages and layouts:
                    </p>
                    <ul class='list-disc list-inside space-y-2'>
                        <li>
                            <a
