...
| Imported by                                    | `auth`, `cli`, `core`, `devtools`, `realtime`                                                                                                                                                |
| **Must never import**                          | `auth`, `auth-provider`, `cli`, `core`, `devtools`, `drizzle`, `init`, `notification`, `openapi`, `realtime`, `testing` — each already reaches this package, so importing one closes a cycle |
