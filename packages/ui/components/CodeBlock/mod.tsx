...
export const CommandBlock: FC<CommandBlockProps> = (
    ...
    return (
        <>
            ...
            <div
                class='my-6 overflow-hidden border border-code-border bg-code-background rounded-(--radius)'
...
export const CodeBlock: FC<CodeBlockProps> = (
    ...
    return (
        <>
            <SyntaxHighlightingStyles theme={theme} />
            <div
                class='my-6 overflow-hidden border border-code-border bg-code-background max-w-full rounded-(--radius)'
                data-hljs-theme={theme}
            >
                <div class='flex items-center justify-between px-4 py-2 bg-code-header-background border-b border-code-border'>
                    <div class='flex items-center gap-2'>
