        ...
        <>
            ...
            <aside
                ...
                class={cn(
                    ...
                    'border-x border-(--sidebar-edge-border,var(--sidebar-border))',
    ...
    return (
        <div
            class={cn(
                ...
                'bg-(--sidebar-header-background,var(--sidebar))',
                'border-b border-(--sidebar-header-border,var(--sidebar-border))',
                className,
            )}
            {...props}
        >
...
export const SidebarFooter: FC<SidebarFooterProps> = ({
    ...
    return (
        <div
            class={cn(
                'flex flex-col gap-2 p-2',
                'bg-(--sidebar-footer-background,var(--sidebar))',
                'border-t border-(--sidebar-footer-border,var(--sidebar-border))',
                className,
            )}
            {...props}
        >
    ...
    return (
        <div
            ...
            class={cn(
                ...
                'bg-(--sidebar-content-background,var(--sidebar))',
                className,
            )}
            {...props}
        >
